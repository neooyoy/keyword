...
var _212=_210.children(".panel-body_easyui");
...
function _219(_21a){
$(_21a).addClass("panel-body_easyui")._size("clear");
...
body.removeClass("panel-body_easyui-noborder");
_224.removeClass("panel-footer-noborder");
}else{
_223.addClass("panel-header-noborder");
body.addClass("panel-body_easyui-noborder");
...
_220.children(".panel-body_easyui").addClass("panel-body_easyui-noheader");
}else{
if(opts.header){
...
_220.children("div.panel-body_easyui").removeClass("panel-body_easyui-noheader");
}
};
...
$(_21e).addClass("panel-body_easyui-nobottom");
}else{
_220.children(".panel-footer").remove();
$(_21e).removeClass("panel-body_easyui-nobottom");
}
};
};
...
var body=_244.children(".panel-body_easyui");
...
var body=_248.children(".panel-body_easyui");
...
return $.data(jq[0],"panel").panel.children(".panel-body_easyui");
...
(function(){
    ...
    /*function searchAll(t, nodes, q){
        var object = {};
        for (var i=0; i<nodes.length; i++){
            var node = nodes[i];
            var text = node.text;
            object.value = text.trim();
            text = $(object).toPinyin();
            if (text.indexOf(q) >= 0){
                $(node.target).show();
            } else {
                $(node.target).hide();
            ...
            if (childNodes != null && childNodes.length > 0){
                searchAll(t, childNodes, q);
            }
        }
    }*/


    /*function expandAll(t, nodes){
        for (var i=0; i<nodes.length; i++){
            if (nodes[i].state == 'closed'){
                t.tree('expand', nodes[i].target);

                var childNodes = t.tree('getChildren', nodes[i].target);
                if (childNodes != null && childNodes.length > 0){
                    expandAll(t, childNodes);
                }
            }
        }
    }*/
